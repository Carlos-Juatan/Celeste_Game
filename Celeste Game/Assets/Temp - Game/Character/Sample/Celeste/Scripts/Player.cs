...
#region Vars
        ...
        // hair
        public static Color NormalHairColor;
        public static Color FlyPowerHairColor;
        public static Color UsedHairColor;
        public static Color FlashHairColor;
        public static Color TwoDashesHairColor;
...
#region Start.
        void Start()
        {
            NormalHairColor = Calc.HexToColor("AC3232");
            FlyPowerHairColor = Calc.HexToColor("F2EB6D");
            UsedHairColor = Calc.HexToColor("44B7FF");
            FlashHairColor = Color.white;
            TwoDashesHairColor = Calc.HexToColor("ff6def");
        }
#endregion
